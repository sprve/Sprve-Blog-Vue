      ...
      <el-row :gutter="30">
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
           <img
              alt=""
              :src= "rewardData.wechat_image
                    ?rewardData.wechat_image
                    :userDataStore.errorImg
                    "
              :onerror=userDataStore.errorImg
            />
        ...
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            <img
              alt=""
              :src= "rewardData.alipay_image
                    ?rewardData.alipay_image
                    :userDataStore.errorImg
                    "
              :onerror=userDataStore.errorImg
            /> 
            <span>支付宝扫一扫，请我喝杯咖啡</span>
          </div>
        </el-col>
      </el-row>
      <h1>@赞赏记录：</h1>
...
<script lang="ts" setup name="reward">
import { onMounted,ref } from 'vue'
import { useUserDataStore } from '@/store/index'

const userDataStore = useUserDataStore()
const rewardData = ref({}) //赞赏二维码
const tableData = [      //赞赏数据  
    {
      "payTime":"2024-1-1",
      "name":"Test",
      "money":"100"
